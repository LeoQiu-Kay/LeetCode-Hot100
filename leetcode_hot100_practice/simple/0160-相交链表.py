...
if __name__ == "__main__":
    ...
    # 期望输出：Intersected at '8'
    print(s.getIntersectionNode(8, [4,1,8,4,5], [5,6,1,8,4,5], 2, 3))

    # 示例 2：输入 intersectVal = 2, listA = [1,9,1,2,4], listB = [3,2,4], skipA = 3, skipB = 1
    # 期望输出：Intersected at '2'
    print(s.getIntersectionNode(2, [1,9,1,2,4], [3,2,4], 3, 1))

    # 示例 3：输入 intersectVal = 0, listA = [2,6,4], listB = [1,5], skipA = 3, skipB = 2
    # 期望输出：No intersection
    print(s.getIntersectionNode(0, [2,6,4], [1,5], 3, 2))
